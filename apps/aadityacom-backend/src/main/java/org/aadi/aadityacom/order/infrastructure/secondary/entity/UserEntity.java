package org.aadi.aadityacom.order.infrastructure.secondary.entity;

import lombok.Getter;
import org.aadi.aadityacom.order.domain.user.aggregate.User;
import org.aadi.aadityacom.order.domain.user.vo.*;
import org.aadi.aadityacom.shared.jpa.AbstractAuditingEntity;
...
public class UserEntity extends AbstractAuditingEntity<Long> {
  ...
  public static User toDomain(UserEntity userEntity) {
    ...
    if(userEntity.getImageURL() != null) {
      user.builder().imageUrl(new UserImageUrl(userEntity.getImageURL()));
    }

    if(userEntity.getAddressStreet() != null) {
      user.builder().userAddress(
        UserAddress.builder()
